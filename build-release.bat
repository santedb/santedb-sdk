...
if exist %nuget% (
	...
	"c:\Program Files (x86)\SanteDB\SDK\sdb-pakr.exe" --optimize --compile --source="..\applets\i18n\fr" --output=".\installsupp\org.santedb.i18n.fe.pak" --keyFile="..\..\keys\org.openiz.core.pfx" --keyPassword="..\..\keys\org.openiz.core.pass" --embedcert
